...
-- query5postgresql.tpl

INSERT INTO time_statistics (template, s_time, stream, query, seed) VALUES ('query5postgresql.tpl', TRANSACTION_TIMESTAMP(), 0, 5, 1859213792);
with ssr as
 (select s_store_id,
...
-- query37postgresql.tpl

INSERT INTO time_statistics (template, s_time, stream, query, seed) VALUES ('query37postgresql.tpl', TRANSACTION_TIMESTAMP(), 0, 37, 1649258240);
select  i_item_id
       ,i_item_desc
       ,i_current_price
 ...
 and i_manufact_id in (667,940,694,808)
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 669 and 669+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Men' and
        (i_color = 'foral' or i_color = 'deep') and
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('Williamson County','Franklin Parish','Bronx County','Williamson County')
...
-- query86postgresql.tpl
INSERT INTO time_statistics (template, s_time, stream, query, seed) VALUES ('query86postgresql.tpl', TRANSACTION_TIMESTAMP(), 0, 86, 579665585);
with results as
...
-- query98postgresql.tpl
INSERT INTO time_statistics (template, s_time, stream, query, seed) VALUES ('query98postgresql.tpl', TRANSACTION_TIMESTAMP(), 0, 98, 937276739);
select i_item_id
      ,i_item_desc 
      ,i_category 
      ,i_class 
